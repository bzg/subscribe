  ...
  {:en
   {:page
    ...
    {:back-to-homepage                         "Back"
     ...
     :not-subscribed-message                   "The email <code>%s</code> is not currently subscribed."
     ...
     :confirmation-error-message               "<p>The confirmation link is invalid or has expired.</p><p>Please try subscribing again.</p>"
   ...
   {:page
    ...
    {:back-to-homepage                         "Accueil"
     ...
     :not-subscribed-message                   "<p>L'adresse e-mail <code>%s</code> n'est pas actuellement abonnée.</p>"
     ...
     :rate-limit                               "Limite de tentatives dépassée"
